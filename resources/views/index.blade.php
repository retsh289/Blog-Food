  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="/"><h2>Food Blog<em>.</em></h2></a>
    ...
    <div class="main-banner header-text">
      <div class="container-fluid">
        <div class="owl-banner owl-carousel">
          <div class="item">
            <img style="height:450px" src="/img/post/{{$postRng[0]->image}}" alt="">
            <div class="item-content">
              <div class="main-content">
                <div class="meta-category">
                  <span>{{$postRng[0] -> tag -> name}}</span>
                </div>
                <a href="/detail/{{$postRng[0]->id}}"><h4>{{$postRng[0] -> title}}</h4></a>
                <ul class="post-info">
                  <li><a href="#">Admin</a></li>
                  <li><a href="#">{{$postRng[0] -> createdAt}}</a></li>
                  <li><a href="#">{{$com[0]}} Comments</a></li>
                </ul>
              </div>
            </div>
          </div>
          <div class="item">
            <img style="height:450px" src="/img/post/{{$postRng[1]->image}}" alt="">
            <div class="item-content">
              <div class="main-content">
                <div class="meta-category">
                  <span>{{$postRng[1] -> tag -> name}}</span>
                </div>
                <a href="/detail/{{$postRng[1]->id}}"><h4>{{$postRng[1] -> title}}</h4></a>
                <ul class="post-info">
                  <li><a href="#">Admin</a></li>
                  <li><a href="#">{{$postRng[1] -> createdAt}}</a></li>
                  <li><a href="#">{{$com[1]}} Comments</a></li>
                </ul>
              </div>
            </div>
          </div>
          <div class="item">
            <img  style="height:450px" src="/img/post/{{$postRng[2]->image}}" alt="">
            <div class="item-content">
              <div class="main-content">
                <div class="meta-category">
                  <span>{{$postRng[2] -> tag -> name}}</span>
                </div>
                <a href="/detail/{{$postRng[2]->id}}"><h4>{{$postRng[2] -> title}}</h4></a>
                <ul class="post-info">
                  <li><a href="#">Admin</a></li>
                  <li><a href="#">{{$postRng[2] -> createdAt}}</a></li>
          ...
          <div class="item">
            <img  style="height:450px" src="/img/post/{{$postRng[3]->image}}" alt="">
            <div class="item-content">
              <div class="main-content">
                <div class="meta-category">
                  <span>{{$postRng[3] -> tag -> name}}</span>
                </div>
                <a href="/detail/{{$postRng[3]->id}}"><h4>{{$postRng[3] -> title}}</h4></a>
                <ul class="post-info">
                  <li><a href="#">Admin</a></li>
                  <li><a href="#">{{$postRng[3] -> createdAt}}</a></li>
                  <li><a href="#">{{$com[3]}} Comments</a></li>
                </ul>
              </div>
            </div>
          </div>
          <div class="item">
            <img  style="height:450px" src="/img/post/{{$postRng[4]->image}}" alt="">
            <div class="item-content">
              <div class="main-content">
                <div class="meta-category">
                  <span>{{$postRng[4] -> tag -> name}}</span>
                </div>
                <a href="/detail/{{$postRng[4]->id}}"><h4>{{$postRng[4] -> title}}</h4></a>
                <ul class="post-info">
                  <li><a href="#">Admin</a></li>
                  <li><a href="#">{{$postRng[4] -> createdAt}}</a></li>
                  <li><a href="#">{{$com[4]}} Comments</a></li>
                </ul>
              </div>
            </div>
          </div>
          <div class="item">
            <img  style="height:450px" src="/img/post/{{$postRng[5]->image}}" alt="">
            <div class="item-content">
              <div class="main-content">
                <div class="meta-category">
                  <span>{{$postRng[5] -> tag -> name}}</span>
                </div>
                <a href="/detail/{{$postRng[5]->id}}"><h4>{{$postRng[5] -> title}}</h4></a>
                <ul class="post-info">
                  <li><a href="#">Admin</a></li>
                  <li><a href="#">{{$postRng[5] -> createdAt}}</a></li>
                  <li><a href="#">{{$com[5]}} Comments</a></li>
                </ul>
              </div>
            </div>
          </div>
                  ...
                  <div class="blog-post">
                    ...
                    <div class="down-content">
                      ...
                      <ul class="post-info">
                        ...
                        @endphp
                        <li><a href="/detail/{{$item->id}}">{{DB::table('comment') -> where('postId',$item -> id) -> count()}} Comments</a></li>
                      </ul>
                        ...
                        <div class="row">
                          <div class="col-6">
                            <ul class="post-tags">
                              ...
                              @endphp
                              @if ($cateName != '')
                              <li><a href="/category/{{$item->categoryId}}">{{$cateName}}</a>,</li>
                              @endif
                              <li><a href="/category/{{$item->tagId}}">{{$item->tag->name}}</a></li>
                            </ul>
                          </div>
                          <div class="col-6">
                            <ul class="post-share">
