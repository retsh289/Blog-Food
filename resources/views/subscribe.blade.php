        ...
        <div class="d-flex justify-content-end">
            ...
            <div class="user-panel pt-2 pb-2 d-flex ">
                ...
                <div class="info d-flex">
                  <a href="/profile" style="font-weight:bold;color:#f48840" class="mr-3">{{Auth::user() -> username}}</a>
                            ...
                            <div class="col-lg-4 col-md-12 mb-4">
                              <div class="card h-100 shadow-lg">
                                ...
                                <div class="card-body text-center">
                                  <button onclick="myplan('Basic')" class="btn btn-primary btn-lg" style="border-radius:30px">Select</button>
                                </div>
                              </div>
                            </div>
                            <div class="col-lg-4 col-md-12 mb-4">
                              <div class="card h-100 shadow-lg">
                                <div class="card-body">
                                  <div class="text-center p-3">
                                    ...
                                    <br><br>
                                    <span class="h2">$25</span>/3 months
                                  </div>
                                </div>
                                <div class="card-body text-center">
                                  <button onclick="myplan('Standard')" class="btn btn-primary btn-lg" style="border-radius:30px">Select</button>
                                </div>
                              </div>
                            </div>
                            <div class="col-lg-4 col-md-12 mb-4">
                              <div id="card" class="card h-100 shadow-lg">
                                <div class="card-body">
                                  <div class="text-center p-3">
                                    <h5 class="card-title">Premium</h5>
                                    <br><br>
                                    <span class="h2">$40</span>/5 months
                                  </div>
                                </div>
                                <div class="card-body text-center">
                                  <button onclick="myplan('Premium')" class="btn btn-primary btn-lg" style="border-radius:30px">Select</button>
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <form action="/subscribe" method="post">
                        ...
                        <div class="row">
                          <div class="col-md-6 col-sm-12">
                            ...
                            <input name="plan" type="text" id="plan" placeholder="Choose your plan"  required="" disabled>
                          </div>
                          <div class="col-md-6 col-sm-12">
                          ...
                          <div class="col-md-12 col-sm-12">
                            ...
                            <input type="text" id="username" required="" value="{{Auth::user()->username}}" name="username" disabled>
                          </div>
                          <div class="col-md-12 col-sm-12">
                          ...
                          <div class="col-md-12 col-sm-12 ">
                            <label class="d-block" for="payment">Payment</label>
                          ...
                          <div class="col-lg-12 mt-5">
                            <fieldset>
                              <button type="submit" id="form-submit" class="main-button">Save Change</button>
                            </fieldset>
                          </div>
                        </div>
                      </form>
