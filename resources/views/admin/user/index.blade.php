            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        @if ($title == 'Member')
                            ...
                            <li class="nav-item">
                                <a href="/admin/member" class="nav-link active" style="background-color:#f48840">
                        ...
                        @if ($title == 'Admin')
                            <li class="nav-item">
                                <a href="/admin/admin" class="nav-link active" style="background-color:#f48840">
                                    <i class="nav-icon fas fa-solid fa-user-lock"></i>
                                    <p>Admin</p>
                                </a>
                            </li>
                                                ...
                                                <tbody>
                                                    @foreach ($user as $item)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @if (isset($item->image))
                                                                    <img src="/img/user/{{ $item->image }}"
                                                                        style='width:150px' alt="">
                                                                @else
                                                                    <img src="/img/no-image.jpg" style='width:150px'
                                                                        alt="">
                                                                @endif
                                                            </td>
